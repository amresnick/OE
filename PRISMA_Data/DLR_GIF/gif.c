...
#define S_FUNCTION_NAME gif
#define S_FUNCTION_LEVEL 2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          7
/* Input Port  0 */
#define IN_PORT_0_NAME      MEM_in
#define INPUT_0_WIDTH       1531
...
/* Input Port  1 */
#define IN_PORT_1_NAME      TC_DLR_GIF
...
/* Input Port  2 */
#define IN_PORT_2_NAME      GPS_TIME
...
/* Input Port  3 */
#define IN_PORT_3_NAME      GPS_msg_adr_MAIN
...
/* Input Port  4 */
#define IN_PORT_4_NAME      GPS_msg_len_MAIN
...
/* Input Port  5 */
#define IN_PORT_5_NAME      GPS_msg_adr_TARGET
...
/* Input Port  6 */
#define IN_PORT_6_NAME      GPS_msg_len_TARGET
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      MEM_out
#define OUTPUT_0_WIDTH       1531
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      DLR_GPS_Obs_Time
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      DLR_GPS_UTC
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      DLR_GPS_MAIN_OBS
#define OUTPUT_4_WIDTH       81
...
/* Output Port  5 */
#define OUT_PORT_5_NAME      DLR_GPS_TARGET_OBS
#define OUTPUT_5_WIDTH       81
...
/* Output Port  6 */
#define OUT_PORT_6_NAME      DLR_GPS_EPH
#define OUTPUT_6_WIDTH       992
...
/* Output Port  7 */
#define OUT_PORT_7_NAME      DLR_TM_GIF
#define OUTPUT_7_WIDTH       5
...
/* Output Port  8 */
#define OUT_PORT_8_NAME      ReqTE_MAIN
#define OUTPUT_8_WIDTH       8
...
/* Output Port  9 */
#define OUT_PORT_9_NAME      ReqTE_TARGET
...
/* Output Port  10 */
#define OUT_PORT_10_NAME      GPS_Status_MAIN
...
/* Output Port  11 */
#define OUT_PORT_11_NAME      GPS_Status_TARGET
...
#define SOURCEFILES "__SFB____SFB____SFB____SFB____SFB____SFB____SFB____SFB__"
#define PANELINDEX           6
...
extern void gif_Outputs_wrapper(const real_T *MEM_in,
...
{
    const real_T   *MEM_in  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *TC_DLR_GIF  = (const real_T*) ssGetInputPortSignal(S,1);
    const uint32_T   *GPS_TIME  = (const uint32_T*) ssGetInputPortSignal(S,2);
    const uint32_T   *GPS_msg_adr_MAIN  = (const uint32_T*) ssGetInputPortSignal(S,3);
    const uint32_T   *GPS_msg_len_MAIN  = (const uint32_T*) ssGetInputPortSignal(S,4);
    const uint32_T   *GPS_msg_adr_TARGET  = (const uint32_T*) ssGetInputPortSignal(S,5);
    const uint32_T   *GPS_msg_len_TARGET  = (const uint32_T*) ssGetInputPortSignal(S,6);
    real_T        *MEM_out  = (real_T *)ssGetOutputPortRealSignal(S,0);
    uint32_T        *TSync  = (uint32_T *)ssGetOutputPortRealSignal(S,1);
    uint32_T        *DLR_GPS_Obs_Time  = (uint32_T *)ssGetOutputPortRealSignal(S,2);
    uint8_T        *DLR_GPS_UTC  = (uint8_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *DLR_GPS_MAIN_OBS  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *DLR_GPS_TARGET_OBS  = (real_T *)ssGetOutputPortRealSignal(S,5);
    real_T        *DLR_GPS_EPH  = (real_T *)ssGetOutputPortRealSignal(S,6);
    uint8_T        *DLR_TM_GIF  = (uint8_T *)ssGetOutputPortRealSignal(S,7);
    uint8_T        *ReqTE_MAIN  = (uint8_T *)ssGetOutputPortRealSignal(S,8);
    uint8_T        *ReqTE_TARGET  = (uint8_T *)ssGetOutputPortRealSignal(S,9);
    uint8_T        *GPS_Status_MAIN  = (uint8_T *)ssGetOutputPortRealSignal(S,10);
    uint8_T        *GPS_Status_TARGET  = (uint8_T *)ssGetOutputPortRealSignal(S,11);

    gif_Outputs_wrapper(MEM_in, TC_DLR_GIF, GPS_TIME, GPS_msg_adr_MAIN, GPS_msg_len_MAIN, GPS_msg_adr_TARGET, GPS_msg_len_TARGET, MEM_out, TSync, DLR_GPS_Obs_Time, DLR_GPS_UTC, DLR_GPS_MAIN_OBS, DLR_GPS_TARGET_OBS, DLR_GPS_EPH, DLR_TM_GIF, ReqTE_MAIN, ReqTE_TARGET, GPS_Status_MAIN, GPS_Status_TARGET);
}
